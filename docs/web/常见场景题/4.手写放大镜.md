        ...
        <script type="text/javascript">
            var magnifier = {
                ...
                moveHandler(event, normalDiv, normalSpan, bigImg) {
                    ...
                    //normalSpan.style.position:"relative";
                    if(x>150){x=150}
                    if(x<0){x=0}
                    if(y>150){y=150}
                    if(y<0){y=0}
                    ...
                    let bigX = x/normalDiv.offsetWidth*bigImg.offsetWidth;
                    let bigY = y/normalDiv.offsetHeight*bigImg.offsetHeight;
            ...
            magnifier.init({
                ...
                src: {
                    normal: 'https://uploadfiles.nowcoder.com/images/20211201/920662346_1638327818015/FE8B1A979ADF6E3C2C114AF3F9CA693C',
